  ...
  (function(ts) {
    ts.Diagnostics = {
      ...
      Dynamic_import_cannot_be_used_when_targeting_ECMAScript_2015_modules: {
        code: 1323,
        category: ts.DiagnosticCategory.Error,
        key: "Dynamic_import_cannot_be_used_when_targeting_ECMAScript_2015_modules_1323",
      ...
      Expected_0_arguments_but_got_a_minimum_of_1: {
        code: 2556,
        category: ts.DiagnosticCategory.Error,
        key: "Expected_0_arguments_but_got_a_minimum_of_1_2556",
        message: "Expected {0} arguments, but got a minimum of {1}."
      },
      Expected_at_least_0_arguments_but_got_a_minimum_of_1: {
        code: 2557,
        category: ts.DiagnosticCategory.Error,
        key: "Expected_at_least_0_arguments_but_got_a_minimum_of_1_2557",
        message: "Expected at least {0} arguments, but got a minimum of {1}."
      },
      ...
      Specify_module_code_generation_Colon_commonjs_amd_system_umd_es2015_or_ESNext: {
        code: 6016,
        category: ts.DiagnosticCategory.Message,
        key: "Specify_module_code_generation_Colon_commonjs_amd_system_umd_es2015_or_ESNext_6016",
        message: "Specify module code generation: 'commonjs', 'amd', 'system', 'umd', 'es2015', or 'ESNext'."
      },
      Print_this_message: {
        code: 6017,
        category: ts.DiagnosticCategory.Message,
  ...
  (function(ts) {
    ...
    function parseJsonConfigFileContent(json, host, basePath, existingOptions, configFileName, resolutionStack, extraFileExtensions) {
      ...
      var options = (function() {
        var _a = parseConfig(json, host, basePath, configFileName, resolutionStack, errors),
            include = _a.include,
            exclude = _a.exclude,
            files = _a.files,
            options = _a.options,
            compileOnSave = _a.compileOnSave;
        if (include) {
    ...
    function getExtendedConfig(extended, host, basePath, getCanonicalFileName, resolutionStack, errors) {
      ...
      var _a = parseConfig(extendedResult.config, host, extendedDirname, ts.getBaseFileName(extendedConfigPath), resolutionStack, errors),
          include = _a.include,
          exclude = _a.exclude,
          files = _a.files,
          options = _a.options,
          compileOnSave = _a.compileOnSave;
      return {
        include: ts.map(include, updatePath),
        exclude: ts.map(exclude, updatePath),
        files: ts.map(files, updatePath),
        compileOnSave: compileOnSave,
        options: options
      };
    }
      ...
      function discoverTypings(host, fileNames, projectRootPath, safeListPath, packageNameToTypingLocation, typeAcquisition, unresolvedImports) {
        ...
        function getTypingNamesFromSourceFileNames(fileNames) {
          ...
          if (safeList !== EmptySafeList) {
            mergeTypings(ts.mapDefined(cleanedTypingNames, function(f) {
              return safeList.get(f);
            }));
          }
  ...
  (function(ts) {
    ...
    function getPackageNameFromAtTypesDirectory(mangledName) {
      ...
      if (withoutAtTypePrefix !== mangledName) {
        return withoutAtTypePrefix.indexOf("__") !== -1 ? "@" + withoutAtTypePrefix.replace(mangledScopedPackageSeparator, ts.directorySeparator) : withoutAtTypePrefix;
      }
      return mangledName;
    }
