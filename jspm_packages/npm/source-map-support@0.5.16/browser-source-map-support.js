        ...
        function h(a, e) {
          ...
          this._sections = c.map(function(a) {
            ...
            var c = d.getArg(a, "offset"),
                k = d.getArg(c, "line"),
                g = d.getArg(c, "column");
            if (k < w.line || k === w.line && g < w.column)
        ...
        b.prototype._serializeMappings = function() {
          for (var a = 0,
            ...
            if (x.generatedLine !== b)
              ...
              if (!g.compareByGeneratedPositionsInflated(x, F[D - 1]))
                continue;
              k += ",";
            }
        ...
        b.prototype.toStringWithSourceMap = function(b) {
          ...
          this.walk(function(b, e) {
            ...
            null !== e.source && null !== e.line && null !== e.column ? (p === e.source && c === e.line && k === e.column && x === e.name || h.addMapping({
              ...
              name: e.name
            }), p = e.source, c = e.line, k = e.column, x = e.name, m = !0) : m && (h.addMapping({generated: {
                line: d,
                column: g
              }}), p = null, m = !1);
            for (var l = 0,
      ...
      21: [function(p, u, m) {
        (function(b) {
          ...
          y.push(function(a) {
            ...
            try {
              if (u)
                u.existsSync(a) && (b = u.readFileSync(a, "utf8"));
              else {
